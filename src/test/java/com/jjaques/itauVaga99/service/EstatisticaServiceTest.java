...
class EstatisticaServiceTest {
    /** Não foram criados testes para {@link TransacaoService}, por exemplo {@code salvarTransacao()}
     * porque aqui nesse teste já são feitas instancias de {@link Transacao}, entendendo que já são testadas.**/
